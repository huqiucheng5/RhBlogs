...
import com.rhb.rhblogs.Utils.MD5Util;
...
//            mAuthTask.execute((Void) null);
    ...
    private void login(String email, String password) {
        ...
        Call<ResponseBody<String>> call = userService.login(email, password);
        call.enqueue(new Callback<ResponseBody<String>>() {
            @Override
            public void onResponse(Call<ResponseBody<String>> call, Response<ResponseBody<String>> response) {
                ...
                if (response.body().getStatus() == 200) {
                    ...
                    MyPreferences.getPreferences(LoginActivity.this).setUserToken(token);
